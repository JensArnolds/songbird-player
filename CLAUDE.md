...
Starchild Music Frontend - A modern music streaming and discovery platform built with Next.js 15, TypeScript, and TailwindCSS v4. Features include audio playback with equalizer, smart recommendations, visual audio patterns, and a Spotify-like mobile experience.
...
- `starchild-music-frontend-prod` - Production (port 3000)
- `starchild-music-frontend-dev` - Development (port 3412)
